...
// 3. KEYMAPS (Must be defined BEFORE the display functions)
...
const uint16_t PROGMEM keymaps[4][MATRIX_ROWS][MATRIX_COLS] = {
    [LAYER_BASE] = LAYOUT(
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,    KC_K,  KC_H,    KC_COMM, KC_DOT,  KC_SLSH, DF(1),
                          KC_G_DF1, MT_ATDE, KC_SPC,  LOWER,   RAISE, KC_BSPC, KC_ENT,  LT(3,KC_MPLY)
    ),
    [LAYER_QWERTY] = LAYOUT(
        KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,  KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS,
    ...
    [LAYER_RAISE] = LAYOUT(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_PPLS, KC_P7,   KC_P8,   KC_P9,   KC_PAST, KC_NLCK,
